...
const realPaths = {
  ...
  Code: {
    ...
    wayBackConf: path.join(path.resolve(base), 'bundledApps/tomcat/webapps/ROOT/WEB-INF/wayback.xml'),
  }
}
...
function createWindow () {
  ...
  console.log(path.join(path.resolve(base), 'bundledApps/tomcat/webapps/ROOT/WEB-INF/wayback.xml'))
