...
// old pywb 0.32.1
const ServiceStatus = ({serviceStatRec, startHeritrix, stopHeritrix, startWayback, stopWayback}) => {
...
export default connect(stateToProps, dispatchToProps)(enhance(ServiceStatus))
